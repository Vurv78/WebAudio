...
desc("pause(xwa:)", "Pauses the stream")
desc("play(xwa:)", "Starts the stream or continues where it left off after pausing")
desc("destroy(xwa:)", "Destroys the WebAudio object, rendering it useless, giving you another slot to make a WebAudio object")
